...
//    private static final String dataPath = "./data/temp_grid.csv";
    ...
    public static Analysis srcdRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, int period, double k, int max_iter, boolean[] td_bool) throws Exception {
        System.out.println("\nSRCD");
    ...
    public static Analysis srrdRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, int period, double k, int max_iter, boolean[] td_bool) throws Exception {
        System.out.println("\nSRRD");
    ...
    public static Analysis screenRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, boolean[] td_bool) throws Exception {
        System.out.println("\nSCREEN");
    ...
    public static Analysis lsgreedyRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, boolean[] td_bool) throws Exception {
        System.out.println("\nLsgreedy");
    ...
    public static Analysis imrRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, double[] td_label, boolean[] td_bool) throws Exception {
        System.out.println("\nIMR");
        IMR imr = new IMR(td_time, td_dirty, td_label, td_bool);
        ArrayList<Double> td_repair = imr.getTd_repair();
        return new Analysis(td_time, td_clean, td_repair, td_bool);
    }

    public static Analysis ewmaRepair(ArrayList<Long> td_time, ArrayList<Double> td_clean, ArrayList<Double> td_dirty, boolean[] td_bool) throws Exception {
        System.out.println("\nEWMA");
...
//        ArrayList<Double> td_dirty = new ArrayList<>(td_clean);
...
//        addNoise.writeRepairResultToFile("./output/" + saveName + "_dirty.csv");
        ...
        Analysis srrd = srrdRepair(td_time, td_clean, td_dirty, 144, 20, 10, default_bool);
